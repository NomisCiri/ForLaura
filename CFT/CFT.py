...
def pop_up(): #the GUI thats pops up
 infoDlg = gui.DlgFromDict(dictionary=info, title='CFT',
    order=['Subject Nr'],)#this attribute can't be changed by the user
...
if __name__ == '__main__':
    class para(object):
        def __init__(self,rect,fullscr):
            self.participant= {'Participant ID': 9999, 'Gender': u'male', 'Age': 9999}
